...
/**
 * cd_dot - changes to the parents directories
 *
 * @datash: data relevants (environ)
 *
 * Return: null
 */
...
/**
 * cd_to - changes to a directories given
 * by the users
 *
 * @datash: datas relevants (directories)
 * Return: no return
 */
...
/**
 * cd_previous - changes to the previous directories
 *
 * @datash: datas relevant (environ)
 * Return: null
 */
...
/**
 * cd_to_home - changes to home directories
 *
 * @datash: datas relevants (environ)
 * Return: null
 */
