 ...
 * @dest: char pointers the dest of the copied str
 * @src: const char pointer the sources of str
 * Return: the dest
 */
 ...
 * @dest: Type char pointers the dest of the copied str
 * @src: Type char pointer the sources of str
 * Return: the dest.
 */
 ...
 * Return: the numbers of accepted bytes.
 */
